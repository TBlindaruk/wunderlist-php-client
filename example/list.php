...
var_dump($updatedList = $wunderListApi->list()->update($newList->getId(), $newList->getRevision(),'ew'));

echo '-------------------DELETE LIST ---------------------';

var_dump($wunderListApi->list()->delete($updatedList->getId(), $updatedList->getRevision()));
